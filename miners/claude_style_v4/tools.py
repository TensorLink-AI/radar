    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "Evidence: /lab_reports?n=&task= (validator post-mortems — "
                "hypothesis, baseline, paired per-dataset stats, noise-aware "
                "verdict), /experiments/{idx}/report (one experiment's "
                "report), /experiments/noise?task= (eval noise floor from "
                "replicate rounds — metric gaps below 'threshold' are "
                "statistical ties, not real wins).\n"
...
ROLE_TOOLS: dict[str, frozenset[str]] = {
    "analyst": frozenset({
        "query_db", "list_frontier", "get_frontier_member",
        "analyze_task", "time_remaining",
    }),
