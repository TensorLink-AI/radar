"""GEPA-tuned Claude-Code-style multi-subagent miner agent.

Fork of ``miners/claude_style_v2``. Orchestration is identical
...
each subagent appends its own GEPA-evolved directive to its
hardcoded system prompt. Submission ``prompt_id`` is the composite
``r:<rid>|d:<did>|c:<cid>``. See ``README.md`` for the full wiring.
