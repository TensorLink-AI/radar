...
def _load_submission(architecture_code: str):
    ...
    # ``SUBMISSION_PATH`` lets the local stack point this at a tempdir
    # instead of the pod-only ``/workspace/`` mount.
    submission_path = os.environ.get("SUBMISSION_PATH", "/workspace/submission.py")
